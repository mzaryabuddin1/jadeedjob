...
let JobController = class JobController {
    ...
    async createJob(body, req) {
        body.filter = mongoose_1.Types.ObjectId.createFromHexString(body.filter);
        body.location = {
            type: 'Point',
...
__decorate([
    ...
    (0, common_1.UsePipes)(new joi_validation_pipe_1.JoiValidationPipe(joi_1.default.object({
        filter: joi_1.default.string().required(),
...
__decorate([
    ...
    (0, common_1.UsePipes)(new joi_validation_pipe_1.JoiValidationPipe(joi_1.default.object({
        lat: joi_1.default.number().required(),
        lng: joi_1.default.number().required(),
        filter: joi_1.default.string().pattern(/^[0-9a-fA-F]{24}$/).optional(),
        page: joi_1.default.number().min(1).optional(),
        limit: joi_1.default.number().min(1).max(10).optional(),
...
__decorate([
    ...
    (0, common_1.UsePipes)(new joi_validation_pipe_1.JoiValidationPipe(joi_1.default.object({
        ...
        sortBy: joi_1.default.string().optional(),
        sortOrder: joi_1.default.string().valid('asc', 'desc').optional(),
        radiusKm: joi_1.default.number().min(1).max(10).optional(),
    }))),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
